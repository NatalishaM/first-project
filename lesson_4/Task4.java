...
public class Task4 {
    public static void main(String[] args) {
        StaticCalculator staticCalculator = new StaticCalculator(30.0, 5.0, "-");
        StaticCalculator staticCalculator2 = new StaticCalculator();
        System.out.println("1." + staticCalculator.calculate());
        System.out.println("2." + staticCalculator2.calculate());
